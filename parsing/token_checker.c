...
/*   Updated: 2025/05/24 11:39:54 by yannis           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int handle_word(int *i, t_token *current_token, t_cmd **current_cmd, t_env *env)
{
    ...
    (*current_cmd)->cmd_args[(*i)] = ft_strndup(current_token->value,ft_strlen(current_token->value));
...
int command_checker(int *i, t_token *current_token, t_cmd **current_cmd, t_env *env)
{
