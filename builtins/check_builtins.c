...
/*   Updated: 2025/05/29 13:32:47 by engiusep         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if(ft_strncmp(cmd->cmd_args[0],"echo", 4) == 0 && ft_strlen(cmd->cmd_args[0]) == 4)
		builtin_echo(cmd);
	else if(ft_strncmp(cmd->cmd_args[0],"env", 3) == 0 && ft_strlen(cmd->cmd_args[0]) == 3)
		builtin_env(shell->env,cmd);
	else if(ft_strncmp(cmd->cmd_args[0],"pwd", 3) == 0 && ft_strlen(cmd->cmd_args[0]) == 3)
		builtin_pwd();
	else
	{
